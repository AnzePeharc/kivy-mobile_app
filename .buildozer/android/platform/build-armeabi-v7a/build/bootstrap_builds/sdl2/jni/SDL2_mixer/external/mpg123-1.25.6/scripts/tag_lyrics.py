...
if (len(sys.argv) > 1):
    ...
    print
    'Give me at least a file name to work on, plus the lyrics from stdin'
    print
    'Optionally, you can provide the language (3 lowercase letters) of the lyrics and a description'
    sys.exit()
...
print
"reading lyrics from standard input ..."
