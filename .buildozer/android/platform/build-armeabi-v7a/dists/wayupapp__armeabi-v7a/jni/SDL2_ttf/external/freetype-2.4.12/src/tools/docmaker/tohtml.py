...
class HtmlFormatter(Formatter):
    ...
    def print_html_field(self, field):
        if field.name:
            print
            "<table><tr valign=top><td><b>" + field.name + "</b></td><td>"
    ...
    def print_html_field_list(self, fields):
        ...
        for field in fields:
            if len(field.name) > 22:
                print
                "<tr valign=top><td colspan=0><b>" + field.name + "</b></td></tr>"
                print
                "<tr valign=top><td></td><td>"
            else:
                print
                "<tr valign=top><td><b>" + field.name + "</b></td><td>"
    ...
    def block_enter(self, block):
        ...
        if block.name:
            print
            '<h4><a name="' + block.name + '">' + block.name + '</a></h4>'
    ...
    def block_exit(self, block):
        print
        block_footer_start + self.file_prefix + "index.html" + \
